...
INSERT INTO `category` VALUES (1,'Træ'),(2,'Beslag & Skruer'),(3,'Tag - Fladt'),(4,'Tag - Rejst');
...
CREATE TABLE `order` (
                         ...
                         CONSTRAINT `fk_order_request1` FOREIGN KEY (`request_id`) REFERENCES `inquiry` (`request_id`),
...
-- Dump completed on 2022-05-10 13:14:15
