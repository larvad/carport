...
INSERT INTO `inquiry` VALUES (2,2400,2400,'B & C Dobbelt Tagsten (Blå)',30,0,0,'2022-05-12 09:39:18'),(3,2400,2400,'Stål',0,7200,6900,'2022-05-12 10:02:27');
...
CREATE TABLE `order` (
  ...
  KEY `fk_order_request1_idx` (`inquiry_id`),
  ...
  CONSTRAINT `fk_order_request1` FOREIGN KEY (`inquiry_id`) REFERENCES `inquiry` (`inquiry_id`),
...
INSERT INTO `order` VALUES (2,2,2,NULL,500,5000,1,'2022-05-12 10:48:01'),(3,3,3,NULL,450,4500,1,'2022-05-12 10:48:01');
...
INSERT INTO `user` VALUES (1,'Bo Bobsen','b@b.dk','1234',2,89898787,'adresse1'),(2,'Ib Ibsen','i@i.dk','1234',1,65656767,'adresse2'),(3,'pip','p@p.dk','1234',1,42424242,'pip 1');
...
-- Dump completed on 2022-05-12 12:50:54
