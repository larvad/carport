            ...
            <div class="table-responsive-xl">
                <table class="table-responsive-sm table" id="myTable">
                    ...
                    <c:forEach var="userOrdersDTO" items="${requestScope.userOrdersDTOList}">
                        ...
                        <tr>
                            <td>
                                <button  type="submit" name="edit" value="${userOrdersDTO.inquiry_id}" formaction="fc/adminEdit?command=adminEdit" style="border: 0px;background-color: white;">
                                ...
                                <button type="submit"  name="CRUD" value="godkend" formaction="fc/adminCRUD" style="border: 0px;background-color: white;">
                                ...
                                <button type="submit" formaction="fc/AdminCRUD" name="CRUD" value="slet" style="border: 0px;background-color: white;">
...
<%--            <input type="hidden" name="command" value="adminEdit">--%>
        </form>
