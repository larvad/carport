...
<t:pagetemplate>
    ...
    <jsp:body>
        ...
        <p>Jump back to the <a href="${pageContext.request.contextPath}/index.jsp">Frontpage</a>,
            or try <a href="${pageContext.request.contextPath}/createUser.jsp">logging</a> in again.</p>
